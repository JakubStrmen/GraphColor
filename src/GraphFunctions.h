...
private:
    ...
    static void colourEdgesOfVertex(Vertex_coloring &vertex, std::map<Undirected_edge, Undirected_edge> edges, std::map<int, Vertex_coloring> vertices);
    ...
    public:
        std::queue<int > queue;
        void edge3COLBFSrecursive(std::map<int, GraphFunctions::Vertex_coloring> &vertices);
